          ...
          >
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <Magnetic>
                <Link
                  to="/contact"
                  className="px-8 py-4 rounded-full bg-canva-gradient-accent text-white font-black text-xs tracking-[0.2em] uppercase shadow-xl shadow-canva-purple/20 hover:scale-105 active:scale-95 transition-all flex items-center gap-2"
                >
                  <Mail size={20} />
                  Hire Me
                </Link>
